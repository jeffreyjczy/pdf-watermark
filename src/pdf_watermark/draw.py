...
def draw_watermarks(
    ...
    page_rotation: int,  # 👈 ADD THIS
):
    watermark = canvas.Canvas(file_name, pagesize=(width, height))

    total_angle = drawing_options.angle + page_rotation
    rotation_angle_rad = total_angle * pi / 180
    ...
    # 🔑 Rotate content INCLUDING page rotation
    watermark.rotate(total_angle)
